...
// const DebtRelief = mongoose.model("DebtRelief", baseSchema);

// module.exports = DebtRelief;
...
const debtReliefSchema = new mongoose.Schema(
  {
...
module.exports = mongoose.model("DebtRelief", debtReliefSchema);
